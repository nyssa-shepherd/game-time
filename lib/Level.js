module.exports = [
  [
    {x:5, y:50, width:600, height:30, color:'#b34700'},
  ...
  [
    {x:5, y:50, width:100, height:30, color:'pink'},
    // {x:110, y:50, width:100, height:30, color:'pink'},
    // {x:215, y:50, width:100, height:30, color:'pink'},
    // {x:320, y:50, width:100, height:30, color:'pink'},
    // {x:425, y:50, width:100, height:30, color:'pink'},
    // {x:530, y:50, width:100, height:30, color:'pink'},
    // {x:635, y:50, width:100, height:30, color:'pink'},
    // {x:5, y:100, width:100, height:30, color:'pink'},
    // {x:110, y:100, width:100, height:30, color:'pink'},
    // {x:215, y:100, width:100, height:30, color:'pink'},
    // {x:320, y:100, width:100, height:30, color:'pink'},
    // {x:425, y:100, width:100, height:30, color:'pink'},
    // {x:530, y:100, width:100, height:30, color:'pink'},
    // {x:635, y:100, width:100, height:30, color:'pink'}
  ],

  [
    {x:5, y:50, width:500, height:30, color:'pink'},
    // {x:110, y:50, width:100, height:30, color:'pink'},
    // {x:215, y:50, width:100, height:30, color:'pink'},
    // {x:320, y:50, width:100, height:30, color:'pink'},
    // {x:425, y:50, width:100, height:30, color:'pink'},
