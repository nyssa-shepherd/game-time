...
module.exports = class Game {
  ...
  showLevelsScreen() {
    if (this.level === 1) {
      ...
      // this parameter of game that returns true or false
      // then in the index file there will be a simultaneous loop that to assign this true or false
      // similar to the request animation frame
      // true is block
      // false is none
